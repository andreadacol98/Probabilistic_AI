...
def discount_cumsum(x, discount):
    ...
    Input: [x0, x1, ..., xn]
    Output: [x0 + discount * x1 + discount^2 * x2 ... discount^n * xn, ... , xn]
    """
...
class VPGBuffer:
    ...
    def end_traj(self, last_val=0):
        ...
        deltas_Gt = rews[:-1]
        self.ret_buf[path_slice] = discount_cumsum(deltas_Gt, self.gamma)
    ...
    def get(self):
        ...
        #self.tdres_buf = self.tdres_buf/self.max_size  #ideally done
        self.tdres_buf = (self.tdres_buf-self.tdres_buf.mean())/self.tdres_buf.std() #ideally done
